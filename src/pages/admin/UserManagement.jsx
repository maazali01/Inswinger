...
export default function UserManagement() {
  ...
  const confirmDeleteUser = async () => {
    ...
    try {
      ...
      const { error } = await supabase.rpc('delete_user', { user_id: confirmDelete });
      if (error) throw error;
  ...
  return (
    <>
      <SEO
        title={SEO_METADATA.adminUserManagement.title}
        description={SEO_METADATA.adminUserManagement.description}
        keywords={SEO_METADATA.adminUserManagement.keywords}
      ...
      <div className="min-h-screen bg-gray-900 text-gray-100">
        ...
        <main className="flex-1 p-8 md:ml-64">
          ...
          <ConfirmModal
            ...
            title="Delete User"
            message="Are you sure you want to delete this user? This action will remove them from both authentication and the database. This cannot be undone."
            type="danger"
